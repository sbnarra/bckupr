...
// backup specific
var BackupIdOverride = newKey("backup-id-override", "overrides generated backup id", "")
...
var LocalContainers = newKey("local-containers", "container config for managing local backups", "./configs/tar.yml")
