...
func (d *Dispatcher) dispatch(ctx contexts.Context) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		ctx := contexts.Create(r.URL.Path, ctx.ContainerBackupDir, ctx.HostBackupDir, ctx.DockerHosts, contexts.Debug(debug), contexts.DryRun(dryRun), func(ctx contexts.Context, data any) {
