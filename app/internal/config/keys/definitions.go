...
var LocalContainers = newKey("local-containers-config", "yaml config for managing local backups", "./app/configs/local/tar.yml")
...
var PoliciesPath = newKey("rotation-policies-config", "rotation policies yaml path", "./app/configs/rotation/policies.yaml")
